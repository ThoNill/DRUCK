...
public class TestDerFilter {
	...
	public void testAppendFilter() {
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","eins"}, 
	...
	public void testIfExistsFilter1() {
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","ok","ziel"}, 				new String[]{"eins","zwei","ziel","ok"});
		
		filter = new IfExistsFilter();
		filter.setCommand("ziel");
		filter.setExists("ok");
	
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","zwei","ok","drei","ziel"}, 	new String[]{"eins","zwei","ziel","zwei","ok","drei"});
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","ok","ziel","endOfFile"}, 				new String[]{"eins","zwei","ziel","ok","endOfFile"});
		
		filter = new IfExistsFilter();
		filter.setCommand("ziel");
		filter.setExists("ok");
	
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","zwei","ok","drei","ziel","endOfFile"}, 	new String[]{"eins","zwei","ziel","zwei","ok","drei","endOfFile"});
	...
	public void testIfExistsFilter2() {
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","ok","ziel"}, 				new String[]{"eins","zwei","ziel"});
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","zwei","ok","drei","ziel"}, 	new String[]{"eins","zwei","ziel"});
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","ok","ziel","endOfFile"}, 				new String[]{"eins","zwei","ziel","ziel","endOfFile"});
		...
		recorderTest(filter,new String[]{"eins","zwei","ziel","ziel","zwei","ok","drei","ziel","endOfFile"}, 	new String[]{"eins","zwei","ziel","ziel","endOfFile"});
	}
