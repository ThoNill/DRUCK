 ...
 * @author Thomas Nill
 * 
 *         Inkludiert eine andere XML Datei anstatt des Inckude Elements. Dises
 *         Element wird durch den Inhalt von filename ersetzt.
 * 
 */
public class IncludeElement extends Element {
    ...
    public void replace() {
        ...
        if (in != null) {
            ...
            XMLDocumentLoader.ersetzeElementDurchTemplate(this, template,
                    sternValue);
