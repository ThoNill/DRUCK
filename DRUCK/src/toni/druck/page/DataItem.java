 ...
 * @author Thomas Nill
 * 
 *         DataItem repräsentiert eine Einheit im Datenstrom, der die Daten für
 *         den Report bereitstellt- Jede Zeile einer Datendatei erzeugt ein
 *         DataItem.
 * 
 *         Ein DataItem ist im Wesentlichen ein Array aus Strings, Eine Zeile
 *         einer Datei wird durch | in die Fekdwerte aufgetrennt. Der erste
 *         Eintrag im Array hat dabei eine besondere Bedeutung, er wird als
 *         Command bezeichnet. Über diesen command Anteil ist dem DataItem ein
 *         Abschnitt des Ausdruckes, eine Section zugeordnet, wenn die Sction
 *         denselben Namen, wie der Command hat.
 * 
 *         Gibt es keinen solchen Abschnitt, so ist dem DataItem kein Abschnitt
 *         zugeordnet, sondern es versorgt über {@link Verteiler} die
 *         {@link Page} mit Daten.
 * 
 *         DataItem mit besonderen Command print, include, layout, output dienen
 *         der Steuerung des Druckvorganges. endOfFile repräsentiert den
 *         Abschluss des Datenstromes
 *
 */
