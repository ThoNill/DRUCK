 ...
 * @author Thomas Nill
 * 
 *         Die aus einer Datendatei eingelesenen Daten werden zunächst in einer
 *         Warteschlange zwischengespeichert, aus der die DataItem zur
 *         eigentliche Abarbeitung abgeholt werden.
 * 
 *         Der Zwischenspeicher dient dazu, dass man auch auf nachfolgende Daten
 *         zugreifen kann. Dazu wird die Warteschlange zuerst bis zur vollen
 *         Kapazität aufgefüllt, erst danach findet die eigentliche Abarbeitung
 *         statt.
 * 
...
public class DataFIFO {
    ...
    private int count = 0;
    private boolean fuellen = true; // Gibt an, ob die Warteschlange voll
                                    // gefüllt werden soll,
