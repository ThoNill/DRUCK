...
public class Main {
	...
	private static void createTestdaten(String filename,String outDir,String inDir)
	...
	public static void probedruck(String pagename,String outDir,String inDir)
		...
		byte[] aTestDaten = erzeugeTestDatei(page, aTestBeschreibung,outDir,inDir);

		createPS(new InputStreamReader(new ByteArrayInputStream(aTestDaten)));

	}

	private static byte[] erzeugeTestDatei(Page page, byte[] aTestBeschreibung,String outDir,String inDir)
			throws FileNotFoundException, IOException {
